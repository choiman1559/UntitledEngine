...
public class ConsoleView extends BorderPane {
  ...
  public ConsoleView(Charset charset) {
    ...
    jp.uphy.javafx.console.KeyBindingUtils.installEmacsKeyBinding(this.textArea);
    setCenter(this.textArea);

    final jp.uphy.javafx.console.TextInputControlStream stream = new jp.uphy.javafx.console.TextInputControlStream(this.textArea, Charset.defaultCharset());
    try {
